...
urlpatterns = [
    ...
    path('lost-pets/create/', views.lost_pet_create, name='lost_pet_create'),
    path('lost-pets/<int:pk>/', views.lost_pet_detail, name='lost_pet_detail'),
    path('lost-pets/<int:pk>/update/', views.lost_pet_update, name='lost_pet_update'),
    path('lost-pets/<int:pk>/delete/', views.lost_pet_delete, name='lost_pet_delete'),
    path('found-pets/', views.found_pet_list, name='found_pet_list'),
    path('found-pets/create/', views.found_pet_create, name='found_pet_create'),
    path('found-pets/<int:pk>/', views.found_pet_detail, name='found_pet_detail'),
    path('found-pets/<int:pk>/update/', views.found_pet_update, name='found_pet_update'),
    path('found-pets/<int:pk>/delete/', views.found_pet_delete, name='found_pet_delete'),
]
